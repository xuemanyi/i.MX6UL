...
#define IOMUX_SW_MUX_BASE           (0x020E0014U)
#define IOMUX_SW_PAD_BASE           (0x020E0204U)
...
/*
 * IOMUX mux control register layout
 */
typedef struct
{
...
/*
 * IOMUX pad control register layout
 */
typedef struct
{
...
/*
 * Peripheral register access pointers
 */
