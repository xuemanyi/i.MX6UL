...
Currently available applets include:
	...
	[, [, [[, [[, acpid, acpid, add-shell, add-shell, addgroup,
	addgroup, adduser, adduser, adjtimex, adjtimex, arch, arch, arp,
	arp, arping, arping, ash, ash, awk, awk, base64, base64, basename,
	basename, beep, beep, blkdiscard, blkdiscard, blkid, blkid,
	blockdev, blockdev, bootchartd, bootchartd, brctl, brctl, bunzip2,
	bunzip2, bzcat, bzcat, bzip2, bzip2, cal, cal, cat, cat, chat, chat,
	chattr, chattr, chgrp, chgrp, chmod, chmod, chown, chown, chpasswd,
	chpasswd, chpst, chpst, chroot, chroot, chrt, chrt, chvt, chvt,
	cksum, cksum, clear, clear, cmp, cmp, comm, comm, conspy, conspy,
	cp, cp, cpio, cpio, crond, crond, crontab, crontab, cryptpw,
	cryptpw, cttyhack, cttyhack, cut, cut, date, date, dc, dc, dd, dd,
	deallocvt, deallocvt, delgroup, delgroup, deluser, deluser, depmod,
	depmod, devmem, devmem, df, df, dhcprelay, diff, diff, dirname,
	dirname, dmesg, dmesg, dnsd, dnsd, dnsdomainname, dnsdomainname,
	dos2unix, dos2unix, dpkg, dpkg, dpkg-deb, dpkg-deb, du, du,
	dumpkmap, dumpkmap, dumpleases, echo, echo, ed, ed, egrep, egrep,
	eject, eject, env, env, envdir, envdir, envuidgid, envuidgid,
	ether-wake, ether-wake, expand, expand, expr, expr, factor, factor,
	fakeidentd, fakeidentd, fallocate, fallocate, false, false, fatattr,
	fatattr, fbset, fbset, fbsplash, fbsplash, fdflush, fdflush,
	fdformat, fdformat, fdisk, fdisk, fgconsole, fgconsole, fgrep,
	fgrep, find, find, findfs, findfs, flock, flock, fold, fold, free,
	free, freeramdisk, freeramdisk, fsck, fsck, fsck.minix, fsck.minix,
	fsfreeze, fsfreeze, fstrim, fstrim, fsync, fsync, ftpd, ftpd,
	ftpget, ftpget, ftpput, ftpput, fuser, fuser, getopt, getopt, getty,
	getty, grep, grep, groups, groups, gunzip, gunzip, gzip, gzip, halt,
	halt, hd, hd, hdparm, hdparm, head, head, hexdump, hexdump, hexedit,
	hexedit, hostid, hostid, hostname, hostname, httpd, httpd, hush,
	hush, hwclock, hwclock, i2cdetect, i2cdetect, i2cdump, i2cdump,
	i2cget, i2cget, i2cset, i2cset, id, id, ifconfig, ifconfig, ifdown,
	ifdown, ifenslave, ifenslave, ifplugd, ifplugd, ifup, ifup, inetd,
	inetd, init, init, insmod, insmod, install, install, ionice, ionice,
	iostat, iostat, ip, ip, ipaddr, ipaddr, ipcalc, ipcalc, ipcrm,
	ipcrm, ipcs, ipcs, iplink, iplink, ipneigh, ipneigh, iproute,
	iproute, iprule, iprule, iptunnel, iptunnel, kbd_mode, kbd_mode,
	kill, kill, killall, killall, killall5, killall5, klogd, klogd,
	last, last, less, less, link, link, linux32, linux32, linux64,
	linux64, linuxrc, linuxrc, ln, ln, loadfont, loadfont, loadkmap,
	loadkmap, logger, logger, login, login, logname, logname, logread,
	logread, losetup, losetup, lpd, lpd, lpq, lpq, lpr, lpr, ls, ls,
	lsattr, lsattr, lsmod, lsmod, lsof, lsof, lspci, lspci, lsscsi,
	lsscsi, lsusb, lsusb, lzcat, lzcat, lzma, lzma, lzop, lzop,
	makedevs, makedevs, makemime, makemime, man, man, md5sum, md5sum,
	mdev, mdev, mesg, mesg, microcom, microcom, mkdir, mkdir, mkdosfs,
	mkdosfs, mke2fs, mke2fs, mkfifo, mkfifo, mkfs.ext2, mkfs.ext2,
	mkfs.minix, mkfs.minix, mkfs.vfat, mkfs.vfat, mknod, mknod,
	mkpasswd, mkpasswd, mkswap, mkswap, mktemp, mktemp, modinfo,
	modinfo, modprobe, modprobe, more, more, mount, mount, mountpoint,
	mountpoint, mpstat, mpstat, mt, mt, mv, mv, nameif, nameif,
	nanddump, nanddump, nandwrite, nandwrite, nbd-client, nbd-client,
	nc, nc, netstat, netstat, nice, nice, nl, nl, nmeter, nmeter, nohup,
	nohup, nproc, nproc, nsenter, nsenter, nslookup, nslookup, ntpd,
	ntpd, nuke, nuke, od, od, openvt, openvt, partprobe, partprobe,
	passwd, passwd, paste, paste, patch, patch, pgrep, pgrep, pidof,
	pidof, ping, ping, ping6, ping6, pipe_progress, pipe_progress,
	pivot_root, pivot_root, pkill, pkill, pmap, pmap, popmaildir,
	popmaildir, poweroff, poweroff, powertop, powertop, printenv,
	printenv, printf, printf, ps, ps, pscan, pscan, pstree, pstree, pwd,
	pwd, pwdx, pwdx, raidautorun, raidautorun, rdate, rdate, rdev, rdev,
	readahead, readahead, readlink, readlink, readprofile, readprofile,
	realpath, realpath, reboot, reboot, reformime, reformime,
	remove-shell, remove-shell, renice, renice, reset, reset, resize,
	resize, resume, resume, rev, rev, rm, rm, rmdir, rmdir, rmmod,
	rmmod, route, route, rpm, rpm, rpm2cpio, rpm2cpio, rtcwake, rtcwake,
	run-init, run-init, run-parts, run-parts, runlevel, runlevel, runsv,
	runsv, runsvdir, runsvdir, rx, rx, script, script, scriptreplay,
	scriptreplay, sed, sed, sendmail, sendmail, seq, seq, setarch,
	setarch, setconsole, setconsole, setfattr, setfattr, setfont,
	setfont, setkeycodes, setkeycodes, setlogcons, setlogcons, setpriv,
	setpriv, setserial, setserial, setsid, setsid, setuidgid, setuidgid,
	sh, sh, sha1sum, sha1sum, sha256sum, sha256sum, sha3sum, sha3sum,
	sha512sum, sha512sum, showkey, showkey, shred, shred, shuf, shuf,
	slattach, slattach, sleep, sleep, smemcap, smemcap, softlimit,
	softlimit, sort, sort, split, split, ssl_client, ssl_client,
	start-stop-daemon, start-stop-daemon, stat, stat, strings, strings,
	stty, stty, su, su, sulogin, sulogin, sum, sum, sv, sv, svc, svc,
	svlogd, svlogd, svok, svok, swapoff, swapoff, swapon, swapon,
	switch_root, switch_root, sync, sync, sysctl, sysctl, syslogd,
	syslogd, tac, tac, tail, tail, tar, tar, taskset, taskset, tc, tc,
	tcpsvd, tcpsvd, tee, tee, telnet, telnet, telnetd, telnetd, test,
	test, tftp, tftp, tftpd, tftpd, time, time, timeout, timeout, top,
	top, touch, touch, tr, tr, traceroute, traceroute, traceroute6,
	traceroute6, true, true, truncate, truncate, tty, tty, ttysize,
	ttysize, tunctl, tunctl, ubiattach, ubiattach, ubidetach, ubidetach,
	ubimkvol, ubimkvol, ubirename, ubirename, ubirmvol, ubirmvol,
	ubirsvol, ubirsvol, ubiupdatevol, ubiupdatevol, udhcpc, udhcpd,
	udpsvd, udpsvd, uevent, uevent, umount, umount, uname, uname,
	unexpand, unexpand, uniq, uniq, unix2dos, unix2dos, unlink, unlink,
	unlzma, unlzma, unshare, unshare, unxz, unxz, unzip, unzip, uptime,
	uptime, users, users, usleep, usleep, uudecode, uudecode, uuencode,
	uuencode, vconfig, vconfig, vi, vi, vlock, vlock, volname, volname,
	w, w, wall, wall, watch, watch, watchdog, watchdog, wc, wc, wget,
	wget, which, which, who, who, whoami, whoami, whois, whois, xargs,
	xargs, xxd, xxd, xz, xz, xzcat, xzcat, yes, yes, zcat, zcat, zcip,
	zcip
